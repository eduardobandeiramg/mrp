...
| **RF010**    | Como operador de produção, devo ser capaz de criar alertas de problemas com peças | Essencial | _web e mobile_ |
| **RF011**    | Como operador de produção, devo ser capaz de realizar o cadastro e gestão de linhas e postos de montagem | Essencial | _web_ |
...
| **RF019**    | Como técnico de estoque, devo ser capaz de atualizar o estoque mediante reabastecimento de peças | Essencial | _mobile_ |
| **RF020**    | Como técnico de estoque, devo ser capaz de atualizar o estoque mediante saída de peças que foram encaminhadas para linha de produção | Essencial | _mobile_ |
| **RF021**    | Como técnico de estoque, devo ser capaz de sinalizar peças em nível crítico | Essencial | _mobile_ |
| **RF022**    | Como técnico de estoque, devo ser capaz de realizar o gerenciamento e monitoramento do estado das peças no inventário | Essencial | _web e mobile_ |
